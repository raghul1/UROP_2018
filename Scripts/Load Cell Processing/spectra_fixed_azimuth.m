...
for i = 1:2
    ...
    for elev_num = 1:3              % new subplot for each azimuth
        ...
        %%      SUBPLOT FORMATTING
        hold off
        subplot_title = sprintf('%d%c Elevation', azim(azim_num), char(176));
    ...
    if i == 1
        ...
        figure_name = sprintf("../../Data/2018-08-26 Data/Figs/Spectra/Fixed azimuth/Azimuth_%d_freq.png", azim(azim_num));
        
    elseif i == 2
        graph_title = sprintf('Magnitude vs Frequency / Velocity, Azimuth = %d', azim(azim_num));
        figure_name = sprintf("../../Data/2018-08-26 Data/Figs/Spectra/Fixed azimuth/Azimuth_%d_freqvel.png", azim(azim_num));
