...
title('Spec vs freq - empty tunnel - v = 0')
leg= legend('$m$ = 0', '$m$ = 1000');
...
ylabel('Magnitude','interpreter','latex','fontsize', 20)
title('Spec vs freq/vel - empty tunnel - v = 0')
leg= legend('$m$ = 0', '$m$ = 1000');
set(leg,'Interpreter','latex','fontsize', 20);
set(gca,'xscale','log','yscale','log','fontsize',15)
hold off
...
xlabel('Frequency','interpreter','latex','fontsize', 20)
ylabel('Magnitude','interpreter','latex','fontsize', 20)
title('Spec vs freq - empty tunnel - v = 10')
leg= legend('$m$ = 0', '$m$ = 1000');
set(leg,'Interpreter','latex','fontsize', 20);
set(gca,'xscale','log','yscale','log','fontsize',15)
hold off
...
xlabel('Frequency / velocity','interpreter','latex','fontsize',20)
ylabel('Magnitude','interpreter','latex','fontsize', 20)
title('Spec vs freq/vel - empty tunnel - v = 10')
leg= legend('$m$ = 0', '$m$ = 1000');
set(leg,'Interpreter','latex','fontsize', 20);
set(gca,'xscale','log','yscale','log','fontsize',15)
hold off
...
xlabel('Frequency','interpreter','latex','fontsize', 20)
ylabel('Magnitude','interpreter','latex','fontsize', 20)
title('Spec vs freq - empty tunnel - v = 15')
leg= legend('$m$ = 0', '$m$ = 1000');
set(leg,'Interpreter','latex','fontsize', 20);
set(gca,'xscale','log','yscale','log','fontsize',15)
hold off
...
xlabel('Frequency / velocity','interpreter','latex','fontsize', 20)
ylabel('Magnitude','interpreter','latex','fontsize', 20)
title('Spec vs freq/vel - empty tunnel - v = 15')
leg= legend('$m$ = 0', '$m$ = 1000');
set(leg,'Interpreter','latex','fontsize', 20);
set(gca,'xscale','log','yscale','log','fontsize',15)
hold off
...
xlabel('Frequency','interpreter','latex','fontsize', 20)
ylabel('Magnitude','interpreter','latex','fontsize', 20)
title('Spec vs freq - empty tunnel - v = 20')
leg= legend('$m$ = 0', '$m$ = 1000');
set(leg,'Interpreter','latex','fontsize', 20);
set(gca,'xscale','log','yscale','log','fontsize',15)
hold off
...
xlabel('Frequency / velocity','interpreter','latex','fontsize', 20)
ylabel('Magnitude','interpreter','latex','fontsize', 20)
title('Spec vs freq/vel - empty tunnel - v = 20')
leg= legend('$m$ = 0', '$m$ = 1000');
set(leg,'Interpreter','latex','fontsize', 20);
set(gca,'xscale','log','yscale','log','fontsize',15)
hold off
